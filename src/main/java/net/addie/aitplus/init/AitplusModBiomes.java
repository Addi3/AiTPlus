		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType == dimensionTypeRegistry.getOrThrow(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					parameters.add(new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.9f, 1f), Climate.Parameter.span(-0.9f, 0.5f), Climate.Parameter.span(-0.9f, 0.1f), Climate.Parameter.span(-0.8f, 0.1f),
							Climate.Parameter.span(0.2f, 0.9f), Climate.Parameter.span(-2f, 0.6f), 0), biomeRegistry.getHolderOrThrow(ResourceKey.create(Registries.BIOME, new ResourceLocation("aitplus", "gallifrey_plains")))));
