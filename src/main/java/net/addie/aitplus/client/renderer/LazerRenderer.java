...
public class LazerRenderer extends EntityRenderer<LazerEntity> {
	...
	public LazerRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modellazer(context.bakeLayer(Modellazer.LAYER_LOCATION));
	}

	@Override
	public void render(LazerEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LazerEntity entity) {
		return texture;
	}
}
