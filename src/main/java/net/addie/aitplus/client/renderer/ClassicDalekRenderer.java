...
public class ClassicDalekRenderer extends MobRenderer<ClassicDalekEntity, Modelclassic_dalek<ClassicDalekEntity>> {
	public ClassicDalekRenderer(EntityRendererProvider.Context context) {
		super(context, new Modelclassic_dalek(context.bakeLayer(Modelclassic_dalek.LAYER_LOCATION)), 0.5f);
		this.addLayer(new RenderLayer<ClassicDalekEntity, Modelclassic_dalek<ClassicDalekEntity>>(this) {
			final ResourceLocation LAYER_TEXTURE = new ResourceLocation("aitplus:textures/entities/classic_dalek_emissive.png");
	...
	public ResourceLocation getTextureLocation(ClassicDalekEntity entity) {
		return new ResourceLocation("aitplus:textures/entities/classic_dalek.png");
	}
