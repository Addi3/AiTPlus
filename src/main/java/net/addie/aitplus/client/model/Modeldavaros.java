...
public class Modeldavaros<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("aitplus", "modeldavaros"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Torso = partdefinition.addOrReplaceChild("Torso", CubeListBuilder.create(), PartPose.offset(0.0F, 13.0F, 1.0F));
		PartDefinition head = Torso.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(53, 2).addBox(-4.0F, -8.0F, -5.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(12, 21).addBox(-6.0F, -10.0F, -1.0F, 12.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -12.0F, 2.0F));
		PartDefinition right_arm = Torso.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(95, 47).mirror().addBox(-3.0F, -3.0F, -1.5F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.0F, -9.0F, 1.0F, -1.0908F, 0.0F, 0.0F));
		PartDefinition left_arm = Torso.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(108, 47).mirror().addBox(1.0F, -3.0F, -1.5F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.0F, -9.0F, 1.0F));
		PartDefinition body = Torso.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(69, 20).addBox(-4.0F, -3.0F, -4.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(53, 43).addBox(-4.0F, -3.0F, -4.0F, 8.0F, 9.0F, 6.0F, new CubeDeformation(0.25F)),
