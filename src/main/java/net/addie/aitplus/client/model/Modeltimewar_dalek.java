...
public class Modeltimewar_dalek<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("aitplus", "modeltimewar_dalek"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition SuctionArm = Torso.addOrReplaceChild("SuctionArm", CubeListBuilder.create(), PartPose.offset(-3.0F, -2.5F, -4.5F));
		PartDefinition ClawArm = Torso.addOrReplaceChild("ClawArm", CubeListBuilder.create(), PartPose.offset(-3.0F, -2.5F, -4.5F));
		PartDefinition FlameThrowerArm = Torso.addOrReplaceChild("FlameThrowerArm", CubeListBuilder.create().texOffs(34, 39).addBox(-0.5F, -0.5F, -7.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(42, 47)
				.addBox(-1.5F, 0.0F, -6.5F, 3.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 47).addBox(0.0F, -1.5F, -6.5F, 0.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -2.5F, -4.5F));
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(0, 18).addBox(-3.5F, -4.0F, -3.5F, 7.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(55, 0).addBox(-4.5F, -1.7F, -4.5F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(55, 0)
						.addBox(-4.5F, -2.9F, -4.5F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(55, 10).addBox(-4.5F, -1.0F, -4.5F, 9.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 5.0F, 1.5F));
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(19, 0).addBox(-4.5F, -3.0F, -4.5F, 9.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-3.5F, -5.0F, -3.5F, 7.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LightRight = Head.addOrReplaceChild("LightRight", CubeListBuilder.create().texOffs(21, 3).addBox(0.0736F, -2.3192F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -3.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(21, 16).addBox(-3.5F, -16.0F, -11.5F, 1.0F, 1.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(28, 25)
				.addBox(-4.5F, -17.0F, -13.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(30, 29).addBox(-4.0F, -16.5F, -12.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
