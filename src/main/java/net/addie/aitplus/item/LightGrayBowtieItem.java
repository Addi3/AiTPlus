...
public abstract class LightGrayBowtieItem extends ArmorItem {
	public LightGrayBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends LightGrayBowtieItem {
