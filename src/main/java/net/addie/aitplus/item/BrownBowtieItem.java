...
public abstract class BrownBowtieItem extends ArmorItem {
	public BrownBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends BrownBowtieItem {
