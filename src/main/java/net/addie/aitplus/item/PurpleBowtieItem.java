...
public abstract class PurpleBowtieItem extends ArmorItem {
	public PurpleBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends PurpleBowtieItem {
