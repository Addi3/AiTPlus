...
public abstract class OrangeBowtieItem extends ArmorItem {
	public OrangeBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends OrangeBowtieItem {
