...
public abstract class LimeBowtieItem extends ArmorItem {
	public LimeBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends LimeBowtieItem {
