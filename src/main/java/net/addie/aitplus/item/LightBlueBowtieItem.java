...
public abstract class LightBlueBowtieItem extends ArmorItem {
	public LightBlueBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends LightBlueBowtieItem {
