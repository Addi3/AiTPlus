...
public abstract class GreenBowtieItem extends ArmorItem {
	public GreenBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends GreenBowtieItem {
