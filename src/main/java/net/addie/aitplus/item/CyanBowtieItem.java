...
public abstract class CyanBowtieItem extends ArmorItem {
	public CyanBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends CyanBowtieItem {
