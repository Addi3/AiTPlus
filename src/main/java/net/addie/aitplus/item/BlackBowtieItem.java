...
public abstract class BlackBowtieItem extends ArmorItem {
	public BlackBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends BlackBowtieItem {
