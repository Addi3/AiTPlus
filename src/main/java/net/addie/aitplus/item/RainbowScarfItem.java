...
public abstract class RainbowScarfItem extends ArmorItem {
	public RainbowScarfItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends RainbowScarfItem {
