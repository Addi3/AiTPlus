...
public abstract class RedBowtieItem extends ArmorItem {
	public RedBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends RedBowtieItem {
