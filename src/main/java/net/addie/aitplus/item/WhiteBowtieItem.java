...
public abstract class WhiteBowtieItem extends ArmorItem {
	public WhiteBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends WhiteBowtieItem {
