...
public abstract class BlueBowtieItem extends ArmorItem {
	public BlueBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends BlueBowtieItem {
