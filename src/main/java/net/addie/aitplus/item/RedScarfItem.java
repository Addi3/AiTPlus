...
public abstract class RedScarfItem extends ArmorItem {
	public RedScarfItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends RedScarfItem {
