...
public abstract class CeleryItem extends ArmorItem {
	public CeleryItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends CeleryItem {
