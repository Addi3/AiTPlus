...
public abstract class PinkBowtieItem extends ArmorItem {
	public PinkBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends PinkBowtieItem {
