...
public abstract class GrayBowtieItem extends ArmorItem {
	public GrayBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends GrayBowtieItem {
