...
public abstract class DalekaniumArmorItem extends ArmorItem {
	public DalekaniumArmorItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends DalekaniumArmorItem {
	...
	public static class Leggings extends DalekaniumArmorItem {
	...
	public static class Boots extends DalekaniumArmorItem {
