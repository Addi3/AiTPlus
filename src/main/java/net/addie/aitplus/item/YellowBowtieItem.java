...
public abstract class YellowBowtieItem extends ArmorItem {
	public YellowBowtieItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends YellowBowtieItem {
