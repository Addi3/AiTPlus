...
public abstract class ScarfItem extends ArmorItem {
	public ScarfItem(Type type, Item.Properties properties) {
	...
	public static class Chestplate extends ScarfItem {
