...
public class EarthshockCybermanEntity extends Monster implements RangedAttackMob {
	public EarthshockCybermanEntity(EntityType<EarthshockCybermanEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 10;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, TimeWarDalekEntity.class, true, true));
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, RenegadeDalekEntity.class, true, true));
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, ReconnaissanceDalekEntity.class, true, true));
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, ImperialDalekEntity.class, true, true));
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, DavarosEntity.class, true, true));
