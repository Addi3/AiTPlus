...
public class RenegadeDalekEntity extends Monster implements RangedAttackMob {
	public RenegadeDalekEntity(EntityType<RenegadeDalekEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, ImperialDalekEntity.class, true, true));
	...
	public static void init() {
		BiomeModifications.create(new ResourceLocation(AitplusMod.MODID, "renegadedalek_entity_spawn")).add(ModificationPhase.ADDITIONS, BiomeSelectors.all(),
				ctx -> ctx.getSpawnSettings().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(AitplusModEntities.RENEGADE_DALEK, 20, 4, 4)));
	}
