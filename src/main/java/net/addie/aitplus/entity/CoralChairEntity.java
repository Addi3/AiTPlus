...
public class CoralChairEntity extends Monster {
	public CoralChairEntity(EntityType<CoralChairEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.1f);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AitplusModItems.CORAL_CHAIR_SPAWN_EGG));
	}
