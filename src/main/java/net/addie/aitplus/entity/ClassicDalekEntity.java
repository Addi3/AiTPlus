...
public class ClassicDalekEntity extends Monster {
	...
	public void baseTick() {
		...
		DalekShootProcedure.execute(world, x, y, z, entity);
	}
	...
	public static void init() {
		BiomeModifications.create(new ResourceLocation(AitplusMod.MODID, "classicdalek_entity_spawn")).add(ModificationPhase.ADDITIONS,
				...
				ctx -> ctx.getSpawnSettings().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(AitplusModEntities.CLASSIC_DALEK, 20, 4, 4)));
	}
